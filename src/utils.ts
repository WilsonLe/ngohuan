...
import { PersonalBlogsMainData } from './models/personal-blogs-main';
import { ResearchBlogsMainData } from './models/research-blogs-main';
...
export class Utils {
  ...
  public static fetchResearchBlog =
    async (): Promise<ResearchBlogsMainData> => {
      let rawResearchBlogsMainData: unknown = undefined;
      ...
      const researchBlogMainData = ResearchBlogsMainData.parse(
        rawResearchBlogsMainData
      );

      return ResearchBlogsMainData.parse(researchBlogMainData);
    };

  public static fetchPersonalBlog =
    async (): Promise<PersonalBlogsMainData> => {
      let rawPersonalBLogsMainData: unknown = undefined;
      ...
      const personalBlogMainData = PersonalBlogsMainData.parse(
        rawPersonalBLogsMainData
      );

      return PersonalBlogsMainData.parse(personalBlogMainData);
    };
}
